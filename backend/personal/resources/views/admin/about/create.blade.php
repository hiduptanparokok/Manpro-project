                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="datepicker" name="birthday" placeholder="YY/MM/DD" type="text"/>
                        </div>

                        <div class="form-group">
                            <label for="helpInputTop">Website</label>
                            <small class="text-muted">eg.<i>someone@example.com</i></small>
                            <input type="text" class="form-control" name="website" id="helpInputTop">
                        </div>

                        <div class="form-group">
                            <label for="helpInputTop">phone</label>
                            <input type="text" class="form-control" name="phone" id="helpInputTop">
                        </div>
                    ...
                    <div class="col-md-6">    
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="city" id="helpInputTop">
                        </div>

                        <div class="form-group">
                            <label for="helpInputTop">age</label>
                            <input type="text" class="form-control" name="age" id="helpInputTop">
                        </div>

                        <div class="form-group">
                            <label for="helpInputTop">degree</label>
                            <input type="text" class="form-control" name="degree" id="helpInputTop">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="work" id="helpInputTop">
                        </div>
